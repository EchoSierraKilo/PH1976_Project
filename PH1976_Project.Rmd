...
par(mfrow=c(2,4))
for(ii in 1:length(train_df.formant)){
...
par(mfrow=c(2,4))
for(ii in 1:length(train_df.formant.std)){
...
This strategy is used frequenty in machine learning and regression applications, and as such, will be used in this analysis. The **Boruta** package in RStudio will be used for this purpose.  
