...
\NormalTok{  best\_models[[subset\_name]] }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{name =}\NormalTok{ best\_model, }\AttributeTok{model =}\NormalTok{ models\_and\_accuracy[[best\_model]]}\SpecialCharTok{$}\NormalTok{model, }\AttributeTok{accuracy =}\NormalTok{ models\_and\_accuracy[[best\_model]]}\SpecialCharTok{$}\NormalTok{accuracy)}
\NormalTok{\}}
...
{\centering \includegraphics[width=1\linewidth,height=1\textheight]{figure/subfeatureresults-1} 
